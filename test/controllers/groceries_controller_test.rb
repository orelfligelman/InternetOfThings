...
class GroceriesControllerTest < ActionController::TestCase
  ...
  test "should create grocery" do
    assert_difference('Grocery.count') do
      post :create, grocery: { dairy: @grocery.dairy, fruit: @grocery.fruit, meat: @grocery.meat, vegetable: @grocery.vegetable }
    end
  ...
  test "should update grocery" do
    patch :update, id: @grocery, grocery: { dairy: @grocery.dairy, fruit: @grocery.fruit, meat: @grocery.meat, vegetable: @grocery.vegetable }
    assert_redirected_to grocery_path(assigns(:grocery))
  end
