...
class ThermometersControllerTest < ActionController::TestCase
  ...
  test "should create thermometer_mailer" do
    assert_difference('Thermometer.count') do
      post :create, thermometer_mailer: { location: @thermometer.location, maxtemp: @thermometer.maxtemp, power: @thermometer.power }
    end
  ...
  test "should update thermometer_mailer" do
    patch :update, id: @thermometer, thermometer_mailer: { location: @thermometer.location, maxtemp: @thermometer.maxtemp, power: @thermometer.power }
    assert_redirected_to thermometer_path(assigns(:thermometer_mailer))
  end
