...
class AppliancesControllerTest < ActionController::TestCase
  ...
  test "should create appliance" do
    assert_difference('Appliance.count') do
      post :create, appliance: { microwave: @appliance.microwave, oven: @appliance.oven, power: @appliance.power, power: @appliance.power }
    end
  ...
  test "should update appliance" do
    patch :update, id: @appliance, appliance: { microwave: @appliance.microwave, oven: @appliance.oven, power: @appliance.power, power: @appliance.power }
    assert_redirected_to appliance_path(assigns(:appliance))
  end
